...
-- Se crea primero la tabla DEPARTMENTS para no tener una relacion ciclica entre esta y MANAGERS y EMPLOYEES
-- pues se necesita la llave principal de esta como foranea en las otras. .
...
-- CUSTOMERS y SUPPLIERS se crean de igual forma para en este orden para evitar relaciones ciclicas.
-- Tienen el mismo tipo de atributos pero son usos de caso distintos.

CREATE TABLE SUPPLIERS (
    SUPPLIER_ID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    SUPPLIER_NAME VARCHAR2(100) NOT NULL,
    CONTACT_INFO VARCHAR2(200) NOT NULL
);
